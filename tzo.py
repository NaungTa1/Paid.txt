...
\033[1;36m--------------------------------------------------\033[0m
[$] Author   : T Z O
[$] Facebook : Than Zaw Oo
[$] Tool     : Test
[$] Version  : \033[1;92m1.0\033[0m
\033[1;36m----------------------------------------------\033[0m""")
def linex():
...
def menu():
			clear()
		#	linex()
			print('\033[1;92m[1] File cloning\033[0m\n\033[1;93m[2] join facebook\033[0m\n\033[1;91m[0] Exit menu\033[0m')
			linex()
...
def trt6(ids,passlist):
    ...
    try: 
        system = requests.get("https://github.com/NaungTa1/Test/blob/main/T.txt").text 
        if Xyteee in system:
